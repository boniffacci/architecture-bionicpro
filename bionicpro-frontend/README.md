...
### Вызов Backend API
- Кнопка "Вызвать GET /reports" отправляет запрос на `http://localhost:3001/reports`
...
```
src/
├── main.tsx          # Точка входа, инициализация Keycloak
├── App.tsx           # Главный компонент с логикой авторизации
├── index.css         # Глобальные стили (Tailwind)
└── components/       # React компоненты

public/
└── silent-check-sso.html  # Файл для silent SSO проверки
```
...
Подробная документация по настройке всей системы: [KEYCLOAK_SETUP.md](../KEYCLOAK_SETUP.md)

...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--telemetry_start_ts",
        type=str,
        help="Начало интервала времени для телеметрии (формат: YYYY-MM-DD HH:MM:SS)"
    )
    parser.add_argument(
        "--telemetry_end_ts",
        type=str,
        help="Конец интервала времени для телеметрии (формат: YYYY-MM-DD HH:MM:SS)"
    )
    ...
    main(telemetry_start_ts=start_ts, telemetry_end_ts=end_ts)

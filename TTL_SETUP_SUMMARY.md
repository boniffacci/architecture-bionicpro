...
### Шаг 4: Проверить метаданные отчёта
```bash
# Сгенерировать отчёт через фронтенд (http://localhost:3000)
# Затем проверить метаданные файла в MinIO

docker compose exec minio mc stat local/reports/default/{user_uuid}/none__2025-12-01T00-00-00.json
```
...
Metadata:
  X-Amz-Meta-Ttl-Days: 7
  X-Amz-Meta-Created-At: 2025-12-02T...
  X-Amz-Meta-Expires-At: 2025-12-09T...
```
